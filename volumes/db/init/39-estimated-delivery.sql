-- =============================================
-- Migration: Estimated Delivery Date/Time
-- =============================================

-- Add estimated_delivery_at column to orders
ALTER TABLE orders ADD COLUMN IF NOT EXISTS estimated_delivery_at TIMESTAMPTZ;

-- Index for queries filtering by estimated delivery
...
-- =============================================
-- Update update_order_status_atomic() to handle estimated_delivery_at
-- =============================================
...
-- =============================================
-- Update get_orders() to include estimated_delivery_at
-- =============================================
...
-- =============================================
-- Update get_order() to include estimated_delivery_at
-- =============================================
