...
DROP POLICY IF EXISTS s3_uploads_auth_all ON storage.s3_multipart_uploads;
DROP POLICY IF EXISTS s3_parts_auth_all ON storage.s3_multipart_uploads_parts;
...
DROP POLICY IF EXISTS buckets_read_anon ON storage.buckets;
...
DROP POLICY IF EXISTS porter_webhooks_admin_read ON public.porter_webhooks;
DROP POLICY IF EXISTS porter_webhooks_admin_insert ON public.porter_webhooks;
DROP POLICY IF EXISTS porter_deliveries_customer_read ON public.porter_deliveries;
DROP POLICY IF EXISTS porter_deliveries_admin_all ON public.porter_deliveries;
...
ALTER TABLE IF EXISTS ONLY public.product_images DROP CONSTRAINT IF EXISTS product_images_uploaded_by_fkey;
ALTER TABLE IF EXISTS ONLY public.product_images DROP CONSTRAINT IF EXISTS product_images_product_id_fkey;
ALTER TABLE IF EXISTS ONLY public.porter_webhooks DROP CONSTRAINT IF EXISTS porter_webhooks_order_id_fkey;
ALTER TABLE IF EXISTS ONLY public.porter_deliveries DROP CONSTRAINT IF EXISTS porter_deliveries_order_id_fkey;
...
DROP TRIGGER IF EXISTS update_porter_deliveries_updated_at ON public.porter_deliveries;
...
DROP INDEX IF EXISTS public.idx_product_images_uploaded_by;
DROP INDEX IF EXISTS public.idx_product_images_upload_token;
DROP INDEX IF EXISTS public.idx_product_images_status_created;
DROP INDEX IF EXISTS public.idx_product_images_product_id;
DROP INDEX IF EXISTS public.idx_product_images_display_order;
DROP INDEX IF EXISTS public.idx_porter_webhooks_porter_order;
DROP INDEX IF EXISTS public.idx_porter_webhooks_order;
DROP INDEX IF EXISTS public.idx_porter_webhooks_created;
DROP INDEX IF EXISTS public.idx_porter_deliveries_status;
DROP INDEX IF EXISTS public.idx_porter_deliveries_porter_order;
DROP INDEX IF EXISTS public.idx_porter_deliveries_order;
...
ALTER TABLE IF EXISTS ONLY public.porter_webhooks DROP CONSTRAINT IF EXISTS porter_webhooks_pkey;
ALTER TABLE IF EXISTS ONLY public.porter_deliveries DROP CONSTRAINT IF EXISTS porter_deliveries_pkey;
ALTER TABLE IF EXISTS ONLY public.porter_deliveries DROP CONSTRAINT IF EXISTS porter_deliveries_order_id_key;
...
DROP TABLE IF EXISTS public.porter_webhooks;
DROP TABLE IF EXISTS public.porter_deliveries;
...
DROP FUNCTION IF EXISTS public.register_and_confirm_product_image(p_product_id uuid, p_storage_path text, p_original_filename character varying, p_file_size integer, p_mime_type character varying);
...
DROP FUNCTION IF EXISTS public.get_store_pickup_coords();
...
DROP FUNCTION IF EXISTS public.confirm_product_image_upload(p_image_id uuid, p_upload_token uuid);
DROP FUNCTION IF EXISTS public.cleanup_orphaned_product_images(p_max_age_hours integer);
...
--
-- Name: delivery_type; Type: TYPE; Schema: public; Owner: supabase_admin
--
...
ALTER TYPE public.delivery_type OWNER TO supabase_admin;
...
--
-- Name: cleanup_expired_data(); Type: FUNCTION; Schema: public; Owner: supabase_admin
--
...
ALTER FUNCTION public.cleanup_expired_data() OWNER TO supabase_admin;

--
-- Name: cleanup_orphaned_product_images(integer); Type: FUNCTION; Schema: public; Owner: supabase_admin
--
...
ALTER FUNCTION public.cleanup_orphaned_product_images(p_max_age_hours integer) OWNER TO supabase_admin;

--
-- Name: confirm_product_image_upload(uuid, uuid); Type: FUNCTION; Schema: public; Owner: supabase_admin
--
...
ALTER FUNCTION public.confirm_product_image_upload(p_image_id uuid, p_upload_token uuid) OWNER TO supabase_admin;

--
-- Name: delivery_assigned_order(uuid, uuid); Type: FUNCTION; Schema: public; Owner: supabase_admin
--
...
ALTER FUNCTION public.delivery_assigned_order(p_order_id uuid, p_staff_id uuid) OWNER TO supabase_admin;
...
--
-- Name: get_store_pickup_coords(); Type: FUNCTION; Schema: public; Owner: supabase_admin
--
...
ALTER FUNCTION public.get_store_pickup_coords() OWNER TO supabase_admin;
...
--
-- Name: is_product_visible(uuid); Type: FUNCTION; Schema: public; Owner: supabase_admin
--
...
ALTER FUNCTION public.is_product_visible(p_product_id uuid) OWNER TO supabase_admin;

--
-- Name: register_and_confirm_product_image(uuid, text, character varying, integer, character varying); Type: FUNCTION; Schema: public; Owner: supabase_admin
--
...
ALTER FUNCTION public.register_and_confirm_product_image(p_product_id uuid, p_storage_path text, p_original_filename character varying, p_file_size integer, p_mime_type character varying) OWNER TO supabase_admin;
...
--
-- Name: user_owns_order(uuid, uuid); Type: FUNCTION; Schema: public; Owner: supabase_admin
--
...
ALTER FUNCTION public.user_owns_order(p_order_id uuid, p_user_id uuid) OWNER TO supabase_admin;
...
--
-- Name: porter_deliveries; Type: TABLE; Schema: public; Owner: supabase_admin
--
...
ALTER TABLE public.porter_deliveries OWNER TO supabase_admin;

--
-- Name: porter_webhooks; Type: TABLE; Schema: public; Owner: supabase_admin
--
...
ALTER TABLE public.porter_webhooks OWNER TO supabase_admin;

--
-- Name: product_images; Type: TABLE; Schema: public; Owner: supabase_admin
--
...
152.58.63.69	1	2026-01-27 11:00:00+00	2026-01-26 15:51:48.860652+00	2026-01-27 11:34:34.287519+00
...
--
-- Data for Name: porter_deliveries; Type: TABLE DATA; Schema: public; Owner: supabase_admin
--
...
--
-- Data for Name: porter_webhooks; Type: TABLE DATA; Schema: public; Owner: supabase_admin
--
...
--
-- Data for Name: product_images; Type: TABLE DATA; Schema: public; Owner: supabase_admin
--
...
7008da12-dfb4-48bd-b0d9-84ecf333e1bb	fecbd54a-f72c-4115-a725-5beb2931fa64	fecbd54a-f72c-4115-a725-5beb2931fa64/1769590675855.png	409b2061-28dd-460c-8cd5-db4a10515c9e.png	944161	image/png	0	\N	confirmed	\N	2026-01-28 08:57:58.650342+00	2026-01-28 08:57:59.807504+00
c15f4ba4-4607-43d6-b8ee-830ffc5f8619	fecbd54a-f72c-4115-a725-5beb2931fa64	fecbd54a-f72c-4115-a725-5beb2931fa64/1769590700769.png	a317df83-7b03-4ad7-9af3-7f99900c9841.png	1477546	image/png	0	\N	confirmed	\N	2026-01-28 09:01:48.334013+00	2026-01-28 09:01:48.49827+00
776c769d-f6b6-4148-beea-1aba87033196	fecbd54a-f72c-4115-a725-5beb2931fa64	fecbd54a-f72c-4115-a725-5beb2931fa64/1769591134337.jpeg	02e99189-c5d7-4e58-a2e7-b02059f0a554.jpeg	56923	image/jpeg	0	\N	confirmed	\N	2026-01-28 09:05:34.528326+00	2026-01-28 09:05:34.708402+00
c82a293c-5859-4f91-b475-f395d2745c23	1983e5a5-8b23-4266-8d8c-9f3aa81a578d	1983e5a5-8b23-4266-8d8c-9f3aa81a578d/1769593974360.png	5fb98b35-7786-4dc1-a125-a789dc7fd1df.png	944161	image/png	0	\N	confirmed	\N	2026-01-28 09:53:06.754969+00	2026-01-28 09:53:07.52629+00
c39fce4f-fd89-4fa6-a611-8982f6cc8317	1983e5a5-8b23-4266-8d8c-9f3aa81a578d	1983e5a5-8b23-4266-8d8c-9f3aa81a578d/1769593999373.png	210dac6e-d9c0-431c-8819-9cb04971cef6.png	1477546	image/png	0	\N	confirmed	\N	2026-01-28 09:53:28.826016+00	2026-01-28 09:53:29.627413+00
7f5b8c5e-455a-4974-b018-f2a2443112ce	1983e5a5-8b23-4266-8d8c-9f3aa81a578d	1983e5a5-8b23-4266-8d8c-9f3aa81a578d/1769594008923.png	a5f43d41-5930-4415-991c-ed139fb78d26.png	1477546	image/png	0	\N	confirmed	\N	2026-01-28 09:53:36.588051+00	2026-01-28 09:53:37.481975+00
88659e3e-f584-47c6-94ac-f58f8bd5d4d1	1983e5a5-8b23-4266-8d8c-9f3aa81a578d	1983e5a5-8b23-4266-8d8c-9f3aa81a578d/1769594228519.jpeg	c6627c45-4baa-42bf-a0a8-43b84956e560.jpeg	1910341	image/jpeg	0	\N	confirmed	\N	2026-01-28 09:57:14.122775+00	2026-01-28 09:57:15.521847+00
...
3eb739cd-ce86-4f29-94dd-39fad4d2fa7d	0f804627-964a-4d3c-8fa3-410d32a7e6c7	4aad87845dfc82253a01010d4b4ab4c48e362876342562308b8233e0b4ceaf9a	2026-03-01 15:33:01.999+00	f	2026-01-30 15:33:02.000546+00
\.
...
c642d4d4-e982-488b-a50f-02a6f57f80a6	product-images	1983e5a5-8b23-4266-8d8c-9f3aa81a578d/1769594008923.png	0f804627-964a-4d3c-8fa3-410d32a7e6c7	2026-01-28 09:53:33.73134+00	2026-01-28 09:53:33.73134+00	2026-01-28 09:53:33.73134+00	{"eTag": "\\"c21d0a1d60def0fcbbe17240cef429c8\\"", "size": 1477546, "mimetype": "image/png", "cacheControl": "no-cache", "lastModified": "2026-01-28T09:53:33.721Z", "contentLength": 1477546, "httpStatusCode": 200}	605796da-c8b1-45bf-b3c1-bde3ec525d45	0f804627-964a-4d3c-8fa3-410d32a7e6c7	{}
...
--
-- Name: porter_deliveries porter_deliveries_order_id_key; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: porter_deliveries porter_deliveries_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: porter_webhooks porter_webhooks_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: product_images product_images_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: idx_orders_delivery_type; Type: INDEX; Schema: public; Owner: supabase_admin
--
...
--
-- Name: idx_porter_deliveries_order; Type: INDEX; Schema: public; Owner: supabase_admin
--
...
--
-- Name: idx_porter_deliveries_porter_order; Type: INDEX; Schema: public; Owner: supabase_admin
--
...
--
-- Name: idx_porter_deliveries_status; Type: INDEX; Schema: public; Owner: supabase_admin
--
...
--
-- Name: idx_porter_webhooks_created; Type: INDEX; Schema: public; Owner: supabase_admin
--
...
--
-- Name: idx_porter_webhooks_order; Type: INDEX; Schema: public; Owner: supabase_admin
--
...
--
-- Name: idx_porter_webhooks_porter_order; Type: INDEX; Schema: public; Owner: supabase_admin
--
...
--
-- Name: idx_product_images_display_order; Type: INDEX; Schema: public; Owner: supabase_admin
--
...
--
-- Name: idx_product_images_product_id; Type: INDEX; Schema: public; Owner: supabase_admin
--
...
--
-- Name: idx_product_images_status_created; Type: INDEX; Schema: public; Owner: supabase_admin
--
...
--
-- Name: idx_product_images_upload_token; Type: INDEX; Schema: public; Owner: supabase_admin
--
...
--
-- Name: idx_product_images_uploaded_by; Type: INDEX; Schema: public; Owner: supabase_admin
--
...
--
-- Name: app_settings update_app_settings_updated_at; Type: TRIGGER; Schema: public; Owner: supabase_admin
--
...
--
-- Name: porter_deliveries update_porter_deliveries_updated_at; Type: TRIGGER; Schema: public; Owner: supabase_admin
--
...
--
-- Name: product_images update_product_images_updated_at; Type: TRIGGER; Schema: public; Owner: supabase_admin
--
...
--
-- Name: porter_deliveries porter_deliveries_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: porter_webhooks porter_webhooks_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: product_images product_images_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: product_images product_images_uploaded_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: porter_deliveries; Type: ROW SECURITY; Schema: public; Owner: supabase_admin
--

ALTER TABLE public.porter_deliveries ENABLE ROW LEVEL SECURITY;

--
-- Name: porter_deliveries porter_deliveries_admin_all; Type: POLICY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: porter_deliveries porter_deliveries_customer_read; Type: POLICY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: porter_webhooks; Type: ROW SECURITY; Schema: public; Owner: supabase_admin
--

ALTER TABLE public.porter_webhooks ENABLE ROW LEVEL SECURITY;

--
-- Name: porter_webhooks porter_webhooks_admin_insert; Type: POLICY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: porter_webhooks porter_webhooks_admin_read; Type: POLICY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: product_images; Type: ROW SECURITY; Schema: public; Owner: supabase_admin
--

ALTER TABLE public.product_images ENABLE ROW LEVEL SECURITY;

--
-- Name: product_images product_images_admin_delete; Type: POLICY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: product_images product_images_admin_insert; Type: POLICY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: product_images product_images_admin_read; Type: POLICY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: product_images product_images_admin_update; Type: POLICY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: product_images product_images_public_read; Type: POLICY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: buckets buckets_read_anon; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--
...
--
-- Name: buckets buckets_read_authenticated; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--
...
--
-- Name: objects product-images-delete; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--
...
--
-- Name: objects product-images-read; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--
...
--
-- Name: objects product-images-update; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--
...
--
-- Name: objects product-images-upload; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--
...
--
-- Name: s3_multipart_uploads_parts s3_parts_auth_all; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--
...
--
-- Name: s3_multipart_uploads s3_uploads_auth_all; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--
...
--
-- Name: FUNCTION cleanup_expired_data(); Type: ACL; Schema: public; Owner: supabase_admin
--
...
--
-- Name: FUNCTION cleanup_orphaned_product_images(p_max_age_hours integer); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.cleanup_orphaned_product_images(p_max_age_hours integer) TO anon;
GRANT ALL ON FUNCTION public.cleanup_orphaned_product_images(p_max_age_hours integer) TO authenticated;
GRANT ALL ON FUNCTION public.cleanup_orphaned_product_images(p_max_age_hours integer) TO service_role;


--
-- Name: FUNCTION confirm_product_image_upload(p_image_id uuid, p_upload_token uuid); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.confirm_product_image_upload(p_image_id uuid, p_upload_token uuid) TO anon;
GRANT ALL ON FUNCTION public.confirm_product_image_upload(p_image_id uuid, p_upload_token uuid) TO authenticated;
GRANT ALL ON FUNCTION public.confirm_product_image_upload(p_image_id uuid, p_upload_token uuid) TO service_role;
...
--
-- Name: FUNCTION delivery_assigned_order(p_order_id uuid, p_staff_id uuid); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.delivery_assigned_order(p_order_id uuid, p_staff_id uuid) TO anon;
GRANT ALL ON FUNCTION public.delivery_assigned_order(p_order_id uuid, p_staff_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.delivery_assigned_order(p_order_id uuid, p_staff_id uuid) TO service_role;
...
--
-- Name: FUNCTION get_store_pickup_coords(); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.get_store_pickup_coords() TO anon;
GRANT ALL ON FUNCTION public.get_store_pickup_coords() TO authenticated;
GRANT ALL ON FUNCTION public.get_store_pickup_coords() TO service_role;
...
--
-- Name: FUNCTION is_product_visible(p_product_id uuid); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.is_product_visible(p_product_id uuid) TO anon;
GRANT ALL ON FUNCTION public.is_product_visible(p_product_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.is_product_visible(p_product_id uuid) TO service_role;


--
-- Name: FUNCTION pg_stat_statements(showtext boolean, OUT userid oid, OUT dbid oid, OUT toplevel boolean, OUT queryid bigint, OUT query text, OUT plans bigint, OUT total_plan_time double precision, OUT min_plan_time double precision, OUT max_plan_time double precision, OUT mean_plan_time double precision, OUT stddev_plan_time double precision, OUT calls bigint, OUT total_exec_time double precision, OUT min_exec_time double precision, OUT max_exec_time double precision, OUT mean_exec_time double precision, OUT stddev_exec_time double precision, OUT rows bigint, OUT shared_blks_hit bigint, OUT shared_blks_read bigint, OUT shared_blks_dirtied bigint, OUT shared_blks_written bigint, OUT local_blks_hit bigint, OUT local_blks_read bigint, OUT local_blks_dirtied bigint, OUT local_blks_written bigint, OUT temp_blks_read bigint, OUT temp_blks_written bigint, OUT blk_read_time double precision, OUT blk_write_time double precision, OUT temp_blk_read_time double precision, OUT temp_blk_write_time double precision, OUT wal_records bigint, OUT wal_fpi bigint, OUT wal_bytes numeric, OUT jit_functions bigint, OUT jit_generation_time double precision, OUT jit_inlining_count bigint, OUT jit_inlining_time double precision, OUT jit_optimization_count bigint, OUT jit_optimization_time double precision, OUT jit_emission_count bigint, OUT jit_emission_time double precision); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.pg_stat_statements(showtext boolean, OUT userid oid, OUT dbid oid, OUT toplevel boolean, OUT queryid bigint, OUT query text, OUT plans bigint, OUT total_plan_time double precision, OUT min_plan_time double precision, OUT max_plan_time double precision, OUT mean_plan_time double precision, OUT stddev_plan_time double precision, OUT calls bigint, OUT total_exec_time double precision, OUT min_exec_time double precision, OUT max_exec_time double precision, OUT mean_exec_time double precision, OUT stddev_exec_time double precision, OUT rows bigint, OUT shared_blks_hit bigint, OUT shared_blks_read bigint, OUT shared_blks_dirtied bigint, OUT shared_blks_written bigint, OUT local_blks_hit bigint, OUT local_blks_read bigint, OUT local_blks_dirtied bigint, OUT local_blks_written bigint, OUT temp_blks_read bigint, OUT temp_blks_written bigint, OUT blk_read_time double precision, OUT blk_write_time double precision, OUT temp_blk_read_time double precision, OUT temp_blk_write_time double precision, OUT wal_records bigint, OUT wal_fpi bigint, OUT wal_bytes numeric, OUT jit_functions bigint, OUT jit_generation_time double precision, OUT jit_inlining_count bigint, OUT jit_inlining_time double precision, OUT jit_optimization_count bigint, OUT jit_optimization_time double precision, OUT jit_emission_count bigint, OUT jit_emission_time double precision) TO anon;
GRANT ALL ON FUNCTION public.pg_stat_statements(showtext boolean, OUT userid oid, OUT dbid oid, OUT toplevel boolean, OUT queryid bigint, OUT query text, OUT plans bigint, OUT total_plan_time double precision, OUT min_plan_time double precision, OUT max_plan_time double precision, OUT mean_plan_time double precision, OUT stddev_plan_time double precision, OUT calls bigint, OUT total_exec_time double precision, OUT min_exec_time double precision, OUT max_exec_time double precision, OUT mean_exec_time double precision, OUT stddev_exec_time double precision, OUT rows bigint, OUT shared_blks_hit bigint, OUT shared_blks_read bigint, OUT shared_blks_dirtied bigint, OUT shared_blks_written bigint, OUT local_blks_hit bigint, OUT local_blks_read bigint, OUT local_blks_dirtied bigint, OUT local_blks_written bigint, OUT temp_blks_read bigint, OUT temp_blks_written bigint, OUT blk_read_time double precision, OUT blk_write_time double precision, OUT temp_blk_read_time double precision, OUT temp_blk_write_time double precision, OUT wal_records bigint, OUT wal_fpi bigint, OUT wal_bytes numeric, OUT jit_functions bigint, OUT jit_generation_time double precision, OUT jit_inlining_count bigint, OUT jit_inlining_time double precision, OUT jit_optimization_count bigint, OUT jit_optimization_time double precision, OUT jit_emission_count bigint, OUT jit_emission_time double precision) TO authenticated;
...
--
-- Name: FUNCTION pg_stat_statements_info(OUT dealloc bigint, OUT stats_reset timestamp with time zone); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.pg_stat_statements_info(OUT dealloc bigint, OUT stats_reset timestamp with time zone) TO anon;
GRANT ALL ON FUNCTION public.pg_stat_statements_info(OUT dealloc bigint, OUT stats_reset timestamp with time zone) TO authenticated;
GRANT ALL ON FUNCTION public.pg_stat_statements_info(OUT dealloc bigint, OUT stats_reset timestamp with time zone) TO service_role;
...
--
-- Name: FUNCTION register_and_confirm_product_image(p_product_id uuid, p_storage_path text, p_original_filename character varying, p_file_size integer, p_mime_type character varying); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.register_and_confirm_product_image(p_product_id uuid, p_storage_path text, p_original_filename character varying, p_file_size integer, p_mime_type character varying) TO anon;
GRANT ALL ON FUNCTION public.register_and_confirm_product_image(p_product_id uuid, p_storage_path text, p_original_filename character varying, p_file_size integer, p_mime_type character varying) TO authenticated;
GRANT ALL ON FUNCTION public.register_and_confirm_product_image(p_product_id uuid, p_storage_path text, p_original_filename character varying, p_file_size integer, p_mime_type character varying) TO service_role;
...
--
-- Name: FUNCTION user_owns_order(p_order_id uuid, p_user_id uuid); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.user_owns_order(p_order_id uuid, p_user_id uuid) TO anon;
GRANT ALL ON FUNCTION public.user_owns_order(p_order_id uuid, p_user_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.user_owns_order(p_order_id uuid, p_user_id uuid) TO service_role;
...
--
-- Name: TABLE porter_deliveries; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT SELECT ON TABLE public.porter_deliveries TO anon;
GRANT ALL ON TABLE public.porter_deliveries TO authenticated;
GRANT ALL ON TABLE public.porter_deliveries TO service_role;


--
-- Name: TABLE porter_webhooks; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT SELECT ON TABLE public.porter_webhooks TO anon;
GRANT ALL ON TABLE public.porter_webhooks TO authenticated;
GRANT ALL ON TABLE public.porter_webhooks TO service_role;


--
-- Name: TABLE product_images; Type: ACL; Schema: public; Owner: supabase_admin
--
